...
function createAndStoreObject(bucketName, bucketMD, objectKey, objMD, authInfo,
    ...
    return async.waterfall([
        ...
        function getReplicationInfo(options, infoArr, next) {
            if (bucketMD.isReplicationOn()) {
                // TODO: Add checks to see if config applies to object.
                metadataStoreParams.replication = 'PENDING';
            }
