...
export class ObjectModelMD {
     ...
     *
     * @param {boolean} nullVersionId - The version id of the null version
     * @return {ObjectMD} itself
     */
     ...
     *
     * @return {boolean} The version id of the null version
     */
    getNullVersionId() {
     ...
     *
     * @return {boolean} The object versionId
     */
    getVersionId() {
     ...
     * Set replication
     *
     * @param {object} replication - replication object
     * @return {ObjectMD} itself
     */
    setReplicationInfo(replication) {
        this._data.replication = replication;
        return this;
    }
